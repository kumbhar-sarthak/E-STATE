              ...
              <div className="p-6 pl-8 font-semibold">
                ...
                <div className="pl-8">
                  ...
                  <div className="pt-5">Before investing in real estate, define your objectives and financial capacity.
                    Determine
                    whether you are buying for rental income, long-term appreciation, or personal use, and assess your
                    budget
                    accordingly.</div>
                  <div className="pt-10">
                    <p className="p-5 ">
                      ...
                      personal
                      use? Answering this question will help you decide the type of property that best suits your needs.
                      Next, evaluate your finances. Consider your savings, existing debts, credit score, and loan eligibility.
                      Decide how much you can invest upfront and how much you may need to borrow. Keep in mind additional
                      costs
                      such as down payment, taxes, maintenance, and registration fees. Having a clear financial picture will
                      help
                      you set realistic expectations and avoid financial strain.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="pl-8">
                  ...
                  <div className="pt-10">
                    <p className="p-5 ">
                      ...
                      understand whether the investment is likely to appreciate. Additionally, learn about government
                      policies,
                      property taxes, and legal requirements that might affect your investment. Understanding the local rental
                      market can help you estimate expected rental income if you plan to lease the property.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="pl-8">
                  ...
                  <div className="pt-10">
                    <p className="p-5 ">
                      ...
                      multiple lenders to get the best deal.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="pl-8">
                  ...
                  <div className="pt-10">
                    <p className="p-5 ">
                      ...
                      how
                      you will manage your investment.
                    </p>
                  </div>
                </div>
              </div>
